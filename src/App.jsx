...
function ConfigurableAI() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const systemMessage = { role: "system", content: personality };
          ...
          <div className="w-2/3 flex flex-col border rounded-lg dark:border-gray-600 dark:bg-gray-800">
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-white dark:bg-gray-800">
              {chatHistory.length === 0 ? (
                <div className="text-center text-gray-500 dark:text-gray-400 mt-8">No messages yet. Start a conversation!</div>
              ) : (
